  ...
  return (
    ...
    <div className="w-full max-w-7xl">
      <div className="flex flex-col md:flex-row-reverse md:items-start">
        {/* Column for the h1 and the first h2, nudged up slightly */}
        <div className="md:w-1/2 text-center md:text-right md:-mt-16 pr-14">  
          ...
          <h2 className="text-lg font-bold tracking-tight py-4 pr-32 text-gray-900 sm:text-xl md:text-2xl">
            لعبتنا  
          </h2>
        </div>
          {/* Column for the other h2 elements */}
          <div className="md:w-1/2 text-center md:text-right md:pr-28">
            <h2 className="text-lg tracking-tight py-4 text-gray-900 sm:text-xl md:text-2xl">
              نمتلك القدرة والخبرة في تحرير الصوت <br/>
              بغض النظر عن ظروف التسجيل
            </h2>
            <h2 className="text-lg font-bold tracking-tight py-4 text-gray-900 sm:text-xl md:text-3xl">
