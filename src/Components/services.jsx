...
export default function Services() {
  ...
  return (
    <div id="Services" className="bg-gray-400 md:leading-30 font-29 pb-64 flex justify-center text-center "> 
      <div style={{ direction: 'rtl' }} data-aos="fade-up" class=" flex w-3/4 mx-auto flex-col p-4 m-2 justify-center text-center bg-gray-300 border border-gray-400 rounded-xl shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
